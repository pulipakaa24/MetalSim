...
| Isaac Lab 3.0-EA reference (its own runs) | like-for-like port of the 3.0 task in progress | flat +27.4 (Newton / MuJoCo Warp), +28.7 (PhysX); rough +14.5, level 5.8 (Newton) at iteration 1499 | [§1.8](docs/PARITY.md#18-isaac-lab-30-ea-reference-isaac-sim-61-measured-on-the-l4-2026-09-25) |
| G1 flat throughput, 4096 envs, full PPO loop | 56.6 K env-steps/s at a 2.5 ms physics step (needed for stability with Isaac's stiff drives) | Isaac Lab 2.3.2 + PhysX on the L4: 45.9 K (measured, 5 ms step); RTX 4090: 82 K (published), MetalSim at 0.69× | [§1.4](docs/PARITY.md#14-throughput-on-the-g1-task-isaacs-protocol-4096-envs) |
