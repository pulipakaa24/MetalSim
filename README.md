...
| Isaac Lab 3.0-EA G1 tasks (its extra push / mass / reset-velocity events), like-for-like on Isaac's own MuJoCo Warp numerics | **flat +27.5 at iteration 1499** (tracking 0.945 / yaw 0.757, falls 0.9 %, 48.9 K env-steps/s; slower rise, level by 1250; 34 early-transient blow-ups at iterations 11–13, none after); **rough +8.4 at 1499, level 5.96** (Isaac Newton +14.5 / 5.80): gap in yaw tracking, joint acceleration and falls (6.9 vs 2.9 %); 823 early-transient blow-ups plus 187 late ones (under investigation); a training-start defect found in the process (no reset before the first episode) is being fixed and both runs will be repeated | flat +27.5 (Newton / MuJoCo Warp, 59.4 K on the L4), +28.9 (PhysX, 47.3 K); rough +14.5, level 5.8 (Newton) at iteration 1499, one seed each | [§1.8](docs/PARITY.md#18-isaac-lab-30-ea-reference-isaac-sim-61-measured-on-the-l4-2026-09-25) |
| G1 flat throughput, 4096 envs | full PPO loop 50.0 K env-steps/s, env step alone 54.2 K, at a 2.5 ms solver step with the task's PhysX-parity contact preset (measured 2026-09-25 evening; with MuJoCo's default contacts, the setting of the earlier 56.6 K / 67.6 K headline, the same session measures 56.2 K / 67.2 K: the preset costs 11 % of the loop, all in the solver; [note](docs/research/throughput_regression_2026-09-25.md)); rough 41.9 K (default contacts, 2026-09-25 morning) | Isaac Lab 3.0 on the L4 (`isaaclab benchmark runtime`, env step alone): 72.0 K with its default Newton / MuJoCo Warp, 45.1 K PhysX; rough 51.2 K / 35.7 K. Isaac Lab 2.3.2 + PhysX on the L4: 45.9 K; RTX 4090: 82 K (published), MetalSim at 0.69× | [§1.4](docs/PARITY.md#14-throughput-on-the-g1-task-isaacs-protocol-4096-envs), [§1.8](docs/PARITY.md#18-isaac-lab-30-ea-reference-isaac-sim-61-measured-on-the-l4-2026-09-25) |
