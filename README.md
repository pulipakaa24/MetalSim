...
| Isaac Lab 3.0-EA G1 tasks (its extra push / mass / reset-velocity events) | like-for-like port (`flat_il3`, `rough_il3`) training now; results follow here when the runs finish | flat +27.4 (Newton / MuJoCo Warp), +28.7 (PhysX); rough +14.5, level 5.8 (Newton) at iteration 1499, one seed each | [§1.8](docs/PARITY.md#18-isaac-lab-30-ea-reference-isaac-sim-61-measured-on-the-l4-2026-09-25) |
