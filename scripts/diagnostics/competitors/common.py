...
ROBOTS = {
    ...
    "humanoid": dict(robot=os.environ.get("HUMANOID_XML", os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))), "upstream/mujoco_warp-ellip/mujoco_warp/test_data/humanoid/humanoid.xml")),
