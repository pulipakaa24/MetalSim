...
- **Newton XPBD backend, same task, 4096 envs (2026-09-24)**: full PPO loop 112.6K env-steps/s at the
  training setting (4 it. at 1.25 ms) vs MuJoCo Warp's 27.7K at its 2.5 ms training setting; Isaac's
