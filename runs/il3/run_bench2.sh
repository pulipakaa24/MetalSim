...
for V in ":" "--reward_cfg flat_il3:" "--reward_cfg flat_il3:--solver_cfg isaaclab3" "--reward_cfg flat_il3:--solver_cfg isaaclab3_cap20" \
         "--reward_cfg flat_il3:--solver_cfg isaaclab3_collide_every_substep" "--reward_cfg flat_il3:--solver_cfg hardlimits" "--reward_cfg flat_il3:--solver_cfg isaaclab3_every_substep_cap20"; do
  A=${V%%:*}; B=${V#*:}
