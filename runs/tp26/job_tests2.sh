...
python -m pytest tests/test_capacity.py tests/test_g1_task_terms.py tests/test_g1_parity.py tests/test_physics.py tests/test_g1_fast_factorization.py -q 2>&1 | tail -5
echo "=== end $(date)"
