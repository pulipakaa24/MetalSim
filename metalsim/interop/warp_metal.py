...
branch ``metalsim`` of the innate-inc fork):
...
try:
    ...
    raise ImportError("metalsim.interop needs pyobjc-framework-Metal") from e
...
def _core():
    ...
    if not getattr(core, "_metalsim_interop_bound", False):
        ...
        core._metalsim_interop_bound = True
    return core
...
class SharedEvent:
    ...
    def __init__(self, device="metal:0", label: str = "metalsim"):
